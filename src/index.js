...
import { getLinks, initializationGravity, initializationIndices, initializationVertices } from './initializations.js';
...
function main () {
  ...
  const anim = animationFrame(vertices, verticesPrev, links);
  function animation(t) {
    const { vertices, verticesPrev } = anim(t);
